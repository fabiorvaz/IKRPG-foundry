/**
 * Classe da Ficha de Item para Armas à Distância (Ranged Weapon Sheet).
 * Define a lógica de visualização e manipulação do formulário da ficha de item.
 */
export class IKRPGRangedWeaponSheet extends ItemSheet {
  /** @override */
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["ikrpg", "sheet", "item", "ranged-weapon"],
      width: 550,
      height: 520,
      tabs: [{
  ...
  /** @override */
  get template() {
    return "systems/ikrpg/templates/items/ranged-weapon-sheet.hbs";
  }
